...
We see that we are left with 6154 cells. Normalize the data as before,

Normalize the data. After removing unwanted cells from the dataset, the next step is to normalize the data. By default, we employ a global-scaling normalization method “LogNormalize” that normalizes the gene expression measurements for each cell by the total expression, multiplies this by a scale factor equal to the median counts of all genes, and log-transforms the result.
```{r, cache.lazy=FALSE}
